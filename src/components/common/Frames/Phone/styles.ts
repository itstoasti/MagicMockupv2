...
export const styles = (): string => {
    ...
    return css`
      ...
      transform: ${(app.imageData || app.videoData) ? app.cssTransformString : ''};
      ...
      /* Ensure video/image content stays behind device frame elements and inherits border radius */
      ...
      .device .device-screen video,
      .device .device-screen img {
        border-radius: inherit;
      }
      
      /* Ensure device frame overlay elements appear above content */
