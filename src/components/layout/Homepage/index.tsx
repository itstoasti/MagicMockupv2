...
import {FaGithub, FaCheck, FaStar, FaDownload, FaPalette, FaMobile, FaDesktop, FaRocket, FaArrowRight, FaPlay, FaImage, FaBolt, FaHeart} from "react-icons/all";
                ...
                <nav className="nav">
                    <div className="nav-container">
                        ...
                        <div className="nav-right">
                            ...
                            <a href="/app" className="nav-app">Open App</a>
                        </div>
                    </div>
                </nav>
                ...
                <section className="hero">
                    <div className="hero-container">
                        <div className="hero-content">
                            ...
                            <h1>Turn screenshots into <span className="gradient-text">beautiful mockups</span></h1>
                            <p>The fastest way to create professional mockups for your websites, apps, and presentations. No downloads, no signups required.</p>
                ...
                <section id="features" className="features">
                    <div className="section-container">
                        <div className="section-header">
                            ...
                            <p>Simple, powerful tools for creating professional mockups</p>
                        </div>
